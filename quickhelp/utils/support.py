...
@frappe.whitelist()
def create_ticket(title: str, raised_by: str, ticket_module: str, description: str, kly_contact_no: str, kly_reference_doc: str ) -> str:
    ...
    payload = {
        "doc": {
            ...
            "kly_contact_no": kly_contact_no,
            "kly_reference_doc": kly_reference_doc,
